...
VERSION_STRING = "sqlmap/%s#%s" % (VERSION, "stable" if STABLE else "")
DESCRIPTION = "SQLmap Updated"
SITE = "http://AnonRising.xyz"
...
BANNER = """\033[01;33m         
 ...
 ____  _     _             ____                        _ 
|  _ \(_)___(_)_ __   __ _/ ___|  __ _ _   _  __ _  __| |
| |_) | / __| | '_ \ / _` \___ \ / _` | | | |/ _` |/ _` |
|  _ <| \__ \ | | | | (_| |___) | (_| | |_| | (_| | (_| |
|_| \_\_|___/_|_| |_|\__, |____/ \__, |\__,_|\__,_|\__,_|
                     |___/          |_|                
                        \033[0m\033[4;37m%s\033[0m\n
""" % (( + hash(VERSION) % 6) if not STABLE else 30, VERSION_STRING.split('/')[-1], SITE)
...
TRIM_STDOUT_DUMP_SIZE = 900000000
